# TODO
#
# Get Lock detect working and enable Mute Until Lock Detect
# 
...
class ADF4531:
    ...
    def __init__(self, PLL_name): 
        ...
        # Dummy Port pin assignments - will be reassigned for each instance 
        ...
        self.R0 = self.add_data([['reserved',1,'0'],  ['integer',16, format(self.integer, '016b')],  ['fraction', 12,  format(self.fraction, '012b')],  ['address', 3,  '000']])
        ...
        self.R1 = self.add_data([['reserved',3,'000'], ['phase_adj', 1, '0' ],  ['prescaler',  1,  self.prescaler],  ['phase',12, format(self.phase,  '012b')],  ['modulus', 12, format(self.modulus,  '012b')],  ['address', 3,  '001b']])
        ...
        self.R2 = self.add_data([['reserved',1,'0'], ['noise_spur_mode',  2,  '11' ], ['mux_out',  3,  '000'], ['ref_doubler',  1,  self.ref_doubler] ,  ['ref_halve',  1,  self.ref_halve], 
        ...
        self.R3 = self.add_data([['reserved', 8, '00000000'], ['band_select_clock_mode',  1,  '0'],  ['ABP',  1,  self.ABP],  ['charge_cancel',  1,  '0'], ['reserved', 2, '00'], ['CSR',  1,  '0'],  ['reserved',  1,  '0'],  
        ...
        self.R4 = self.add_data([['reserved',8,'00000000'],  ['feedbackType',1, self.feedbackType], ['rf_divider',3, self.rf_divider], ['band_select_clk_divider', 8,'00001000'], ['VCO_power_down',  1,  '0'],  
        ...
        self.R5 = self.add_data([['reserved',8,'00000000'],  ['LD_pin_mode',2, '01'],  ['reserved', 19,  '0110000000000000000'],  ['address', 3,  '101']])
    ...
    # Write a 32 bit number serially to register - address is least sig 3 bits         
    def write_to_register(self, register):
     ...
     # Read data out of register MSBit first 
        ...
        io.output(self.loadEnable,0)         
        # And re-enable PLL chip 
        io.output(self.chipEnable,1) 
                
        
      # Setup PLL at initialization 
    def initialize_registers(self):       
     ...
     # Update relevant registers after frequency change      
    def update(self): 
        ...
        self.R1 = self.add_data([['reserved',3,'000'], ['phase_adj', 1, '0' ],  ['prescaler',  1,  self.prescaler],  ['phase',12, format(self.phase,  '012b')],  ['modulus', 12, format(self.modulus,  '012b')],  ['address', 3,  '001']])
        self.write_to_register(self.R1)
    ...
    # Check freq limits and set up divider, integer and fraction    
